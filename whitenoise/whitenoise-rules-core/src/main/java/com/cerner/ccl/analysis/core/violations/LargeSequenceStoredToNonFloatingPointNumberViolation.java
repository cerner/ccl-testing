...
/**
 * A {@link Violation} indicating that the resulting value of a SEQ() function (and a corresponding cnvtreal) was
 * stored to a variable that was not define to store floating point numbers
 * <p>
 *
...
public class LargeSequenceStoredToNonFloatingPointNumberViolation implements Violation {
     ...
     * 		The name of the variable to which the seqResultVariable was attempted to be stored. This is the non-float value in violation
     * @param lineNumber
     *            An {@link Integer} representing the line at which the violation was encountered, if applicable.
     */
    public LargeSequenceStoredToNonFloatingPointNumberViolation(final String seqResultVariable, final String attemptedStoreVariable, final Integer lineNumber) {
    ...
    public boolean equals(final Object obj) {
        ...
        return StringUtils.equalsIgnoreCase(seqResultVariable, other.seqResultVariable) && StringUtils.equalsIgnoreCase(attemptedStoreVariable, other.attemptedStoreVariable)
    ...
    public String getViolationDescription() {
        return "Attempt to store result of SEQ() into non-floating point variable with assignment " + attemptedStoreVariable + " = " + seqResultVariable;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(StringUtils.lowerCase(seqResultVariable, Locale.US)).append(StringUtils.lowerCase(attemptedStoreVariable, Locale.US)).append(getLineNumber()).toHashCode();
    }
