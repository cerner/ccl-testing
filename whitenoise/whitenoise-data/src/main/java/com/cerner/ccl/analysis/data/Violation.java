...
public interface Violation {
     ...
     * 
     * @return {@code null} if insufficient line number information was available, or a line number is inapplicable to this violation; otherwise, an {@link Integer} representing the line within the
     *         CCL program - after the in-line inclusion of include files - at which this violation appears.
     */
